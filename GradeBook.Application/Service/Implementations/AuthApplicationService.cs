namespace GradeBook.Application.Service.Implementations
{
    ...
    public class AuthApplicationService: IAuthApplicationService
    {
        ...
        public async Task<JwTokenDto> PerformRegistration(RegisterDto model)
        {
            ...
            var roleResult = await _userInMgr.AddToRoleAsync(user, Roles.Student);
            ...
            var claimResult = await _userInMgr.AddClaimAsync(user, new Claim(ClaimTypes.Role, Roles.Student));
        ...
        private async Task<Notification> ValidateAuthentication(LoginDto model)
        {
            ...
            User user = await _userInMgr.FindByNameAsync(model.UserName);
        ...
        private async Task<JwTokenDto> GenerateToken(string username)
        {
